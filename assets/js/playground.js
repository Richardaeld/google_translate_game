...
function populateGame(difficulty, numberOfCards, time, language0, language1, cardType) {  
    ...
    constructCard(numberOfCards, "col-3 col-md-2 card-frame ml-3");                     //Outer most container
    constructCard(numberOfCards, "row no-gutters middle cardRotate", "col-3");          //Middle container for cardRotate, that holds both card front and card back
