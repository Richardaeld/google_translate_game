...
function populateGame(difficulty, numberOfCards, time, language0, language1, cardType) {      //creates game for play by using user selections 
    globalLanguage0 = language0;
    globalLanguage1 = language1;
